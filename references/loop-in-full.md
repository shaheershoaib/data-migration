# The loop in full - reasoning and worked cases behind every rule in SKILL.md

SKILL.md is the loop an agent follows. This file is the long form it was condensed from:
the same steps with the reasoning, the failure each rule prevents and the worked cases.
Read a section here when a rule in SKILL.md seems wrong for your migration.
